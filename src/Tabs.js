...
export default function BasicDemo(props) {
  ...
  //console.log("test5",Box.localStorage.getItem("assetid"))
  ...
  const payload1={
    "custId":50,
   // "ASSET_ID":"00-00-00-00-00-00-10-05"
   "ASSET_ID": props.data
  }
  //console.log("test5",props.data)
  localStorage.setItem("assetid1", props.data)
  const getDeviceData = () => {    
...
function TempSen1() {
  const [SensorData, setSensorData] = useState([])
          const payload={
            ASSET_ID:localStorage.getItem("assetid1"),
            Mode:"recent",
